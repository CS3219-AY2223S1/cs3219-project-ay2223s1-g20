...
# adapted from https://github.com/Bishalsarang/Leetcode-Questions-Scraper
...
def download(problem_num, url, title, solution_slug):  
    ...
    try:
        ...
        problem_html = problem_title_html + '<br>' + str(soup.find("div", diff = True)) + '<br>' + str(soup.find("div", {"class": "content__u3I1 question-content__JfgR"})) + '<br><br><hr><br>'
...
def main():
    ...
    try: 
        for i in range(completed_upto + 1, len(links)):
             ...
             # Sleep for 5 secs for each problem and 10 secs after every 30 problems
             if i % 30 == 0:
